      ...
      body: ListView(
        ...
        children: [
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FilledButton.icon(
                    ...
                    label: Text(
                      _isSubmitting ? 'Searching...' : 'Search files',
                    ),
                  ),
                ),
              ],
          ...
          if (_isSubmitting)
                ...
                children: [
                  Wrap(
                    ...
                    children: [
                      ...
                      Chip(
                        label: Text('${_result!.retrievedDocuments} documents'),
                      ),
                      Chip(label: Text('${_result!.retrievedChunks} passages')),
                    ],
                  ),
            ...
            SectionCard(
              title: 'Sources used',
              subtitle: 'Open the document to check the passage directly.',
              child: Column(
